...
function Array() {
  return (
   ...
   <div style={{ 
      ...
      <h2 style={{ marginBottom: '10px' ,marginTop: '3rem',fontWeight:'bold',fontFamily:'inherit',fontSize:'3rem',paddingBottom:'1rem'}}>Array Data Structure</h2>
      <p style={{fontSize : '2rem',paddingBottom:'2rem',paddingLeft:'2rem'}}>
      ...
      <p   style={{paddingLeft:'2rem'}}>An array is a collection of items of the same variable type that are stored at contiguous memory locations. It’s one of the most popular and simple data structures and is often used to implement other data structures. Each item in an array is indexed starting with 0. Each element in an array is accessed through its index.</p>
      <img src="https://docs.oracle.com/javase/tutorial/figures/java/objects-tenElementArray.gif" alt="Array Image" style={{ width: '60%', height: 'auto', margin: '10px 0' , marginLeft:'400px',paddingBottom:'2rem'}} />
      <h5>Need of Array Data Structures</h5>
      <p style={{paddingLeft:'2rem'}}>Arrays are a fundamental data structure in computer science. They are used in a wide variety of applications, including:</p>
      <ul>
      ...
      <div style={{width:'50rem',height:'3rem',marginBottom:'2rem'}} >

      <a href="https://www.geeksforgeeks.org/array-data-structure/" style={{fontSize:'2rem',borderRadius:'2px',marginBottom:'2rem'}}>Questions</a>      
      </div>
      <Link to="/quiza"><button style={{ backgroundColor: 'green', color: 'white', border: 'none', borderRadius: '5px', padding: '10px 20px', cursor: 'pointer',fontSize:'2rem' }} >Take Quiz</button></Link> {/* Link to the quiz component */}
    </div>
     <Footer />
